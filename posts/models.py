...
class Posts(models.Model):
  ...
  user = models.ForeignKey(Accounts, verbose_name='user_id', on_delete=models.CASCADE)
...
class Tasks(models.Model):
  ...
  post = models.ForeignKey(Posts, verbose_name='post_id', on_delete=models.CASCADE)
  created_at = models.DateTimeField(auto_now_add=True)
  updated_at = models.DateTimeField(auto_now=True)
